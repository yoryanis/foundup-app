    ...
    return this.globalService
      ...
      .pipe(
        map((res) => {
          ...
          if (this.userInfo.rol.id === ROLE.ADMIN) {
            this.toastr.warning(
              'Hemos detectado que intenta ingresar con un tipo de usuario Administrador, el cual no es permitido dentro de esta plataforma.',
